        ...
        <div className="mt-14 grid gap-6 md:grid-cols-3">
          {problems.map((item, i) => (
            <ScrollReveal
              key={item.title}
              delay={i * 0.1}
              className="group relative rounded-2xl border border-white/10 bg-surface p-8 transition-all duration-300 hover:border-red-500/40 hover:shadow-lg hover:shadow-red-500/5"
            >
